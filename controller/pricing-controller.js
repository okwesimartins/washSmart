...
export const updatePricing = async (req, res, next) => {
    const {id,wash_and_fold_one_time, wash_and_fold_smart_wash,dry_cleaning,ironing}=
    req.body;
    if(id && wash_and_fold_one_time && wash_and_fold_smart_wash && dry_cleaning,ironing){
        if(id && dry_cleaning.top && dry_cleaning.bottom && dry_cleaning.full_body && dry_cleaning.house_hold){
